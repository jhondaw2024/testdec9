...
function Chat() {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    return setErrorText('use your paid OpenAI API key to make this work.');
    if (!text) return;
      ...
      <div className='chat'>
        <section className={`sidebar ${isShowSidebar ? 'open' : ''}`}>
          <div className='sidebar-header' onClick={createNewChat} role='button'>
            <BiPlus size={20} />
            <button className='txt'>New Chat</button>
          </div>
        ...
        <section className='main'>
          {!currentTitle && (
            <div className='empty-chat-container'>
              <img
                ...
                alt='ChatGPT'
              />
              <h1 className='txt'>Chat GPT </h1>
              <h3 className='txt'>How can I help you today?</h3>
            </div>
          )}
          ...
          <div className='main-bottom'>
            ...
            <form className='form-container' onSubmit={submitHandler}>
              ...
              />
              {!isResponseLoading && (
                <button className='styl' type='submit'>
                  <BiSend size={20} />
                </button>
              )}
            </form>
